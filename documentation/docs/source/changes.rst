...
* Added Python 3.10–3.13 support with a reproducible ``uv`` lock and GitHub
  Actions matrix.
* Refreshed bundled model artifacts under a constrained producer ABI and added
  strict model-quality gates.
* Added verified asset bootstrapping for release models, corpora, Stanford NLP,
