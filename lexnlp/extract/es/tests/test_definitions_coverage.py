...
from lexnlp.extract.es.definitions import get_definition_list, get_definitions
...
class TestEsGetDefinitionsWrappers(TestCase):
    ...
    def test_get_definitions_empty(self):
        self.assertEqual([], list(get_definitions("Hola.")))
        self.assertEqual([], list(get_definitions("")))

    def test_get_definition_list_empty(self):
        self.assertEqual([], get_definition_list("Hola."))
        self.assertEqual([], get_definition_list(""))
        self.assertEqual([], get_definition_list("Ella está muerta. "))
